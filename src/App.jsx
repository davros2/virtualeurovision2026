...
export default function App() {
  ...
  const allCountries = [
    { name: 'Albania', artist: 'Alis', song: 'Nân', runningOrder: 5 },
    { name: 'Armenia', artist: 'Simón', song: 'Paloma Rumba', runningOrder: null },
    { name: 'Australia', artist: 'Delta Goodrem', song: 'Eclipse', runningOrder: 8 },
    { name: 'Austria', artist: 'Cosmó', song: 'Tanzschein', runningOrder: 25 },
    { name: 'Azerbaijan', artist: 'Jiva', song: 'Just Go', runningOrder: null },
    { name: 'Belgium', artist: 'Essyla', song: 'Dancing on the Ice', runningOrder: 4 },
    { name: 'Bulgaria', artist: 'Dara', song: 'Bangaranga', runningOrder: 12 },
    { name: 'Croatia', artist: 'Lelek', song: 'Andromeda', runningOrder: 13 },
    { name: 'Cyprus', artist: 'Antigoni', song: 'Jalla', runningOrder: 21 },
    { name: 'Czechia', artist: 'Daniel Zizka', song: 'Crossroads', runningOrder: 11 },
    { name: 'Denmark', artist: 'Søren Torpegaard Lund', song: 'Før vi går hjem', runningOrder: 1 },
    { name: 'Estonia', artist: 'Vanilla Ninja', song: 'Too Epic to Be True', runningOrder: null },
    { name: 'Finland', artist: 'Linda Lampenius and Pete Parkkonen', song: 'Liekinheitin', runningOrder: 17 },
    { name: 'France', artist: 'Monroe', song: 'Regarde !', runningOrder: 15 },
    { name: 'Georgia', artist: 'Bzikebi', song: 'On Replay', runningOrder: null },
    { name: 'Germany', artist: 'Sarah Engels', song: 'Fire', runningOrder: 2 },
    { name: 'Greece', artist: 'Akylas', song: 'Ferto (Φέρτο)', runningOrder: 6 },
    { name: 'Israel', artist: 'Noam Bettan', song: 'Michelle', runningOrder: 3 },
    { name: 'Italy', artist: 'Sal Da Vinci', song: 'Per sempre sì', runningOrder: 22 },
    { name: 'Latvia', artist: 'Atvara', song: 'Ēnā', runningOrder: null },
    { name: 'Lithuania', artist: 'Lion Ceccah', song: 'Sólo quiero más', runningOrder: 19 },
    { name: 'Luxembourg', artist: 'Eva Marija', song: 'Mother Nature', runningOrder: null },
    { name: 'Malta', artist: 'Aidan', song: 'Bella', runningOrder: 10 },
    { name: 'Moldova', artist: 'Satoshi', song: 'Viva, Moldova!', runningOrder: 16 },
    { name: 'Montenegro', artist: 'Tamara Živković', song: 'Nova zora (Нова зора)', runningOrder: null },
    { name: 'Norway', artist: 'Jonas Lovv', song: 'Ya Ya Ya', runningOrder: 23 },
    { name: 'Poland', artist: 'Alicja', song: 'Pray', runningOrder: 18 },
    ...
    { name: 'Serbia', artist: 'Lavina', song: 'Kraj mene (Крај mene)', runningOrder: 9 },
    { name: 'Sweden', artist: 'Felicia', song: 'My System', runningOrder: 20 },
    { name: 'Switzerland', artist: 'Veronica Fusaro', song: 'Alice', runningOrder: null },
    { name: 'Ukraine', artist: 'Lelėka', song: 'Ridnym (Рідним)', runningOrder: 7 },
    { name: 'United Kingdom', artist: 'Look Mum No Computer', song: 'Eins, Zwei, Drei', runningOrder: 14 }
  ];
